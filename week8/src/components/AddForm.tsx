...
import type { FormData, Part, RandomUserApiResponse } from '../types/lion';
...
function AddForm({ isOpen, onClose, onSubmit, nextId }: AddFormProps) {
  ...
  async function handleRandomFill(): Promise<void> {
